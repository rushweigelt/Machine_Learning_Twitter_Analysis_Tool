...
#User Vars
tweetid_wrong = 'tweetid'
userid_wrong = 'userid'
follower_count_wrong = 'follower_count'
following_count_wrong = 'following_count'
account_creation_date_wrong = 'account_creation_date'
user_profile_description_wrong = 'user_profile_description'
#Tweet Vars
tweet_text_wrong = 'tweet_text'
reply_count_wrong = 'reply_count'
like_count_wrong = 'like_count'
